...
/** SeaTunnel row type. */
public final class LjsRow implements Serializable {
    ...
    public LjsRow(int arity) {
        this.fields = new Object[arity];
    }

    public LjsRow(Object[] fields) {
        this.fields = fields;
    }
    ...
    public LjsRow copy() {
        ...
        LjsRow newRow = new LjsRow(newFields);
        newRow.setRowKind(this.getRowKind());
        newRow.setTableId(this.getTableId());
        return newRow;
    }

    public LjsRow copy(int[] indexMapping) {
    ...
    public int getBytesSize(LjsRowType rowType) {
        if (size == 0) {
            int s = 0;
    ...
    /** faster version of {@link #getBytesSize(LjsRowType)}. */
    private int getBytesForValue(Object v, LjsDataType<?> dataType) {
        if (v == null) {
            return 0;
        }
        ...
        switch (sqlType) {
            ...
            case TIMESTAMP:
                return 48;
            case ARRAY:
                LjsDataType elementType = ((ArrayType) dataType).getElementType();
            ...
            case ROW:
                int rowSize = 0;
                LjsRowType rowType = ((LjsRowType) dataType);
                LjsDataType<?>[] types = rowType.getFieldTypes();
                LjsRow row = (LjsRow) v;
    ...
    private int getBytesForArray(Object v, LjsDataType<?> dataType) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LjsRow)) {
            return false;
        }
        LjsRow that = (LjsRow) o;
