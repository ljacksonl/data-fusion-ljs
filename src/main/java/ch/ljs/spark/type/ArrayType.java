...
public class ArrayType<T, E> implements LjsDataType<T> {
    ...
    private final LjsDataType<E> elementType;

    protected ArrayType(Class<T> arrayClass, LjsDataType<E> elementType) {
        this.arrayClass = arrayClass;
        this.elementType = elementType;
    }

    public LjsDataType<E> getElementType() {
        return elementType;
    }
