...
public class MapType<K, V> implements CompositeType<Map<K, V>> {
    ...
    private final LjsDataType<K> keyType;
    private final LjsDataType<V> valueType;

    public MapType(LjsDataType<K> keyType, LjsDataType<V> valueType) {
    ...
    public LjsDataType<K> getKeyType() {
        return keyType;
    }

    public LjsDataType<V> getValueType() {
        return valueType;
    }
